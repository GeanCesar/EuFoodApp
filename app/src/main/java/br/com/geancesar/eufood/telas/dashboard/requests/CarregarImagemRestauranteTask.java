...
public class CarregarImagemRestauranteTask extends AsyncTask  {
    OkHttpClient client = new OkHttpClient();
    String url = "http://192.168.15.103:8080/restaurante/imagem_perfil?uuid-restaurante={uuid}";
    ...
    public CarregarImagemRestauranteTask(DashboardListener listener, String uuid, ListItemRestauranteAdapter.ViewHolder holder, String tokenUsuario){
    ...
    protected void onPostExecute(Object o) {
        if(o != null) {
            ...
            listener.getImagemRestaurante((String) resp.getExtra(), uuid);
        }
    }
}
